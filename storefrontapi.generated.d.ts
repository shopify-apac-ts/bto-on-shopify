...
export type GtuneProductsQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type GtuneProductsQuery = {
  fzi9g90?: StorefrontAPI.Maybe<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query GtuneProducts($country: CountryCode, $language: LanguageCode)\n    @inContext(country: $country, language: $language) {\n    fzi9g90: product(handle: "g-tune-fz-i9g90") {\n      id\n      handle\n      title\n      priceRange {\n        minVariantPrice {\n          amount\n          currencyCode\n        }\n      }\n      featuredImage {\n        id\n        url\n        altText\n        width\n        height\n      }\n    }\n  }\n': {
    return: GtuneProductsQuery;
    variables: GtuneProductsQueryVariables;
  };
